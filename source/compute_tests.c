...
static struct compute_test_descriptor const test_descriptors[] =
{
    ...
    // TEST("FSETP.F",                     0x0000dead, fsetp_f,                   8),
    TEST("FSETP.LT 1",                  0x0000cafe, fsetp_lt_1,                8),
    TEST("FSETP.LT 2",                  0x0000dead, fsetp_lt_2,                8),
    TEST("FSETP.LT 3",                  0x0000dead, fsetp_lt_3,                8),
    TEST("FSETP.LT 4",                  0x0000dead, fsetp_lt_4,                8),
    TEST("FSETP.LT 5",                  0x0000dead, fsetp_lt_5,                8),
    TEST("FSETP.EQ 1",                  0x0000cafe, fsetp_eq_1,                8),
    TEST("FSETP.EQ 2",                  0x0000dead, fsetp_eq_2,                8),
    TEST("FSETP.EQ 3",                  0x0000dead, fsetp_eq_3,                8),
    TEST("FSETP.EQ 4",                  0x0000dead, fsetp_eq_4,                8),
    TEST("FSETP.EQ 5",                  0x0000dead, fsetp_eq_5,                8),
    TEST("FSETP.LE 1",                  0x0000dead, fsetp_le_1,                8),
    TEST("FSETP.LE 2",                  0x0000cafe, fsetp_le_2,                8),
    TEST("FSETP.LE 3",                  0x0000cafe, fsetp_le_3,                8),
    TEST("FSETP.LE 4",                  0x0000dead, fsetp_le_4,                8),
    TEST("FSETP.LE 5",                  0x0000dead, fsetp_le_5,                8),
    TEST("FSETP.GT 1",                  0x0000cafe, fsetp_gt_1,                8),
    TEST("FSETP.GT 2",                  0x0000dead, fsetp_gt_2,                8),
    TEST("FSETP.GT 3",                  0x0000dead, fsetp_gt_3,                8),
    TEST("FSETP.GT 4",                  0x0000dead, fsetp_gt_4,                8),
    TEST("FSETP.GT 5",                  0x0000dead, fsetp_gt_5,                8),
    TEST("FSETP.NE 1",                  0x0000cafe, fsetp_ne_1,                8),
    TEST("FSETP.NE 2",                  0x0000dead, fsetp_ne_2,                8),
    TEST("FSETP.NE 3",                  0x0000dead, fsetp_ne_3,                8),
    TEST("FSETP.NE 4",                  0x0000dead, fsetp_ne_4,                8),
    TEST("FSETP.GE 1",                  0x0000cafe, fsetp_ge_1,                8),
    TEST("FSETP.GE 2",                  0x0000cafe, fsetp_ge_2,                8),
    TEST("FSETP.GE 3",                  0x0000dead, fsetp_ge_3,                8),
    TEST("FSETP.GE 4",                  0x0000dead, fsetp_ge_4,                8),
    TEST("FSETP.GE 5",                  0x0000dead, fsetp_ge_5,                8),
    // TEST("FSETP.NUM 1",                 0x0000cafe, fsetp_num_1,               8),
    // TEST("FSETP.NUM 2",                 0x0000dead, fsetp_num_2,               8),
    // TEST("FSETP.NUM 3",                 0x0000dead, fsetp_num_3,               8),
    // TEST("FSETP.NUM 4",                 0x0000dead, fsetp_num_4,               8),
    // TEST("FSETP.NAN 1",                 0x0000dead, fsetp_nan_1,               8),
    // TEST("FSETP.NAN 2",                 0x0000cafe, fsetp_nan_2,               8),
    // TEST("FSETP.NAN 3",                 0x0000cafe, fsetp_nan_3,               8),
    // TEST("FSETP.NAN 4",                 0x0000cafe, fsetp_nan_4,               8),
    TEST("FSETP.LTU 1",                 0x0000cafe, fsetp_ltu_1,               8),
    TEST("FSETP.LTU 2",                 0x0000dead, fsetp_ltu_2,               8),
    TEST("FSETP.LTU 3",                 0x0000cafe, fsetp_ltu_3,               8),
    TEST("FSETP.LTU 4",                 0x0000cafe, fsetp_ltu_4,               8),
    TEST("FSETP.LTU 5",                 0x0000cafe, fsetp_ltu_5,               8),
    // TEST("FSETP.EQU 1",                 0x0000cafe, fsetp_equ_1,               8),
    // TEST("FSETP.EQU 2",                 0x0000cafe, fsetp_equ_2,               8),
    // TEST("FSETP.EQU 3",                 0x0000cafe, fsetp_equ_3,               8),
    // TEST("FSETP.EQU 4",                 0x0000cafe, fsetp_equ_4,               8),
    // TEST("FSETP.EQU 5",                 0x0000dead, fsetp_equ_5,               8),
    TEST("FSETP.LEU 1",                 0x0000dead, fsetp_leu_1,               8),
    TEST("FSETP.LEU 2",                 0x0000cafe, fsetp_leu_2,               8),
    TEST("FSETP.LEU 3",                 0x0000cafe, fsetp_leu_3,               8),
    TEST("FSETP.LEU 4",                 0x0000cafe, fsetp_leu_4,               8),
    TEST("FSETP.LEU 5",                 0x0000cafe, fsetp_leu_5,               8),
    TEST("FSETP.GTU 1",                 0x0000cafe, fsetp_gtu_1,               8),
    TEST("FSETP.GTU 2",                 0x0000dead, fsetp_gtu_2,               8),
    TEST("FSETP.GTU 3",                 0x0000dead, fsetp_gtu_3,               8),
    TEST("FSETP.GTU 4",                 0x0000cafe, fsetp_gtu_4,               8),
    TEST("FSETP.GTU 5",                 0x0000cafe, fsetp_gtu_5,               8),
    TEST("FSETP.NEU 1",                 0x0000cafe, fsetp_neu_1,               8),
    TEST("FSETP.NEU 2",                 0x0000dead, fsetp_neu_2,               8),
    TEST("FSETP.NEU 3",                 0x0000cafe, fsetp_neu_3,               8),
    TEST("FSETP.NEU 4",                 0x0000cafe, fsetp_neu_4,               8),
    TEST("FSETP.GEU 1",                 0x0000cafe, fsetp_geu_1,               8),
    TEST("FSETP.GEU 2",                 0x0000cafe, fsetp_geu_2,               8),
    TEST("FSETP.GEU 3",                 0x0000dead, fsetp_geu_3,               8),
    TEST("FSETP.GEU 4",                 0x0000cafe, fsetp_geu_4,               8),
    TEST("FSETP.GEU 5",                 0x0000cafe, fsetp_geu_5,               8),
    // TEST("FSETP.T",                     0x0000dead, fsetp_t,                   8),
    ...
    TEST("SHF_R.L 1",                   0xccbbaa1a, shf_r_left_1,              8),
    TEST("SHF_R.L 2",                   0x0d218ae1, shf_r_left_2,              8),
    TEST("SHF_R.L 3",                   0x1a4315c8, shf_r_left_3,              8),
    TEST("SHF_R.R 1",                   0xde000085, shf_r_right_1,             8),
    TEST("SHF_R.R 2",                   0x11fde5a9, shf_r_right_2,             8),
    TEST("SHF_R.R 3",                   0x23fbcb53, shf_r_right_3,             8),
    TEST("SHF_R.R 4",                   0xcafe8888, shf_r_right_4,             8),
    TEST("SHF_R.R.W",                   0x44800000, shf_r_right_w,             8),
    TEST("SHF_IMM.L",                   0xccbbaa1a, shf_imm_left,              8),
    TEST("SHF_IMM.R",                   0xaa1a4315, shf_imm_right,             8),
    TEST("SHF_R.L.S64",                 0x00000000, shf_r_left_s64,            8),
    TEST("SHF_R.L.W.S64",               0x1020304c, shf_r_left_w_s64,          8),
    TEST("SHF_IMM.L.S64 1",             0xd0000000, shf_imm_left_s64_1,        8),
    TEST("SHF_IMM.L.S64 2",             0x2345aabb, shf_imm_left_s64_2,        8),
    TEST("SHF_IMM.L.S64 3",             0x1020304c, shf_imm_left_s64_3,        8),
    TEST("SHF_R.R.U64",                 0xcafe5555, shf_r_right_u64,           8),
    TEST("SHF_IMM.R.S64",               0xffffff80, shf_imm_right_s64,         8),
    TEST("SHF_IMM.R.U64",               0x00000080, shf_imm_right_u64,         8),
    ...
    TEST("FCMP_R 1",                    0x00000011, fcmp_1,                    8),
    TEST("FCMP_R 2",                    0x00000088, fcmp_2,                    8),
    TEST("FCMP_R 3",                    0x00000011, fcmp_3,                    8),
    TEST("FCMP_R 4",                    0x00000088, fcmp_4,                    8),
    ...
    TEST("I2I.S32.S32",                 0xace007de, i2i_s32_s32,               8),
    TEST("I2I.U32.U32",                 0xbebeadad, i2i_u32_u32,               8),
    TEST("I2I.U32.S16 Ra.H0",           0x00002f82, i2i_u32_s16_h0,            8),
    TEST("I2I.U32.S16 Ra.H1",           0xffff93a0, i2i_u32_s16_h1,            8),
    TEST("I2I.U32.U16 Ra.H0",           0x0000adad, i2i_u32_u16,               8),
    TEST("I2I.U32.U16 Ra.H1",           0x0000bebe, i2i_u32_u16_h1,            8),
    TEST("I2I.U32.S8 Ra.B0",            0xffffff82, i2i_u32_s8_b0,             8),
    TEST("I2I.U32.S8 Ra.B1",            0x0000002f, i2i_u32_s8_b1,             8),
    TEST("I2I.U32.S8 Ra.B2",            0xffffffa0, i2i_u32_s8_b2,             8),
    TEST("I2I.U32.S8 Ra.B3",            0xffffff93, i2i_u32_s8_b3,             8),
    TEST("I2I.U32.U8 Ra.B0",            0x00000060, i2i_u32_u8_b0,             8),
    TEST("I2I.U32.U8 Ra.B1",            0x00000014, i2i_u32_u8_b1,             8),
    TEST("I2I.U32.U8 Ra.B2",            0x00000095, i2i_u32_u8_b2,             8),
    TEST("I2I.U32.U8 Ra.B3",            0x000000ea, i2i_u32_u8_b3,             8),
    TEST("I2I.S16.S32",                 0x000007de, i2i_s16_s32,               8),
    TEST("I2I.U16.S32",                 0x000007da, i2i_u16_s32,               8),
    TEST("I2I.U16.U32",                 0x0000ddee, i2i_u16_u32,               8),
    TEST("I2I.S8.S32",                  0x000000da, i2i_s8_s32,                8),
    TEST("I2I.U8.U32",                  0x000000ee, i2i_u8_u32,                8),
    TEST("I2I.U16.U32.SAT",             0x0000ffff, i2i_u16_u32_sat,           8),
    TEST("I2I.U16.S32.SAT 1",           0x00000000, i2i_u16_s32_sat_1,         8),
    TEST("I2I.U16.S32.SAT 2",           0x0000ffff, i2i_u16_s32_sat_2,         8),
    TEST("I2I.S16.S32.SAT 1",           0xffff8000, i2i_s16_s32_sat_1,         8),
    TEST("I2I.S16.S32.SAT 2",           0x00007fff, i2i_s16_s32_sat_2,         8),
    TEST("I2I.S8.S32.SAT",              0xffffff80, i2i_s8_s32_sat,            8),
    TEST("I2I.U32.S32",                 0xbebeadad, i2i_u32_s32,               8),
    TEST("I2I.U32.S32.SAT",             0x000000aa, i2i_u32_s32_sat,           8),
    TEST("I2I.S32.U32.SAT",             0x7fffffff, i2i_s32_u32_sat,           8),
    TEST("I2I.U32.S16.SAT",             0x00000000, i2i_u32_s16_sat,           8),
    TEST("I2I.U32.S8.SAT 1",            0x00000002, i2i_u32_s8_sat_1,          8),
    TEST("I2I.U32.S8.SAT 2",            0x00000009, i2i_u32_s8_sat_2,          8),
    TEST("I2I.S8.U32.SAT",              0x0000007f, i2i_s8_u32_sat,            8),
    TEST("I2I.S32.S32 -Ra",             0xffffffd8, i2i_s32_s32_neg,           8),
    TEST("I2I.S32.S32 |Ra|",            0x00000032, i2i_s32_s32_abs,           8),
    TEST("I2I.S32.S32 -|Ra|",           0xffffffce, i2i_s32_s32_neg_abs,       8),
    TEST("I2I.U32.U32 -Ra",             0xfffffffc, i2i_u32_u32_neg,           8),
    TEST("I2I.U32.U32 |Ra|",            0x7ffffffc, i2i_u32_u32_abs,           8),
    ...
    TEST("IADD_R.CC Overflow",          0xe000000a, iadd_r_cc_overflow,        8),
    ...
    TEST("IADD_R.X Rd.CC 1",            0x8000000a, iadd_r_x_cc_1,             8),
    TEST("IADD_R.X Rd.CC 2",            0x00000005, iadd_r_x_cc_2,             8),
    ...
    TEST("LEA_R",                       0x0002015e, lea_r,                     8),
    TEST("LEA_R -Ra",                   0xfffdff5e, lea_r_neg,                 8),
    TEST("LEA_R.HI",                    0x6000775f, lea_r_hi,                  8),
    TEST("VMNMX.MX S32 S32",            0x00000008, vmnmx_mx_s32_s32,          8),
    TEST("VMNMX.MX U32 U32",            0x90000000, vmnmx_mx_u32_u32,          8),
    TEST("VMNMX.MX U32 S32",            0xc0000000, vmnmx_mx_u32_s32,          8),
    TEST("VMNMX.MX S32 U32",            0x00000023, vmnmx_mx_s32_u32,          8),
    TEST("VMNMX.MN S32 U32",            0xc5600000, vmnmx_mn_s32_u32,          8),
    TEST("VMNMX.MX.MAX S32 S32",        0x00000008, vmnmx_mx_s32_s32_max,      8),
    TEST("VMNMX.MX.MAX U32 U32",        0x00000010, vmnmx_mx_u32_u32_max,      8),
    TEST("VMNMX.UD.MX.MAX U32 U32",     0xccccdede, vmnmx_ud_mx_u32_u32_max,   8),
    TEST("VMNMX.MX.ACC U32 U32",        0x60005000, vmnmx_mx_u32_u32_acc,      8),
    TEST("VMNMX.MX.SAT.ACC U32 U32",    0x80004fff, vmnmx_mx_u32_u32_sat_acc,  8),
    TEST("VMNMX.UD.MX.SAT U32 U32",     0x80000000, vmnmx_ud_mx_u32_u32_sat,   8),
    TEST("VMNMX.MX.MRG_16H U32 U32",    0x2000cccc, vmnmx_mx_u32_u32_mrg_16h,  8),
    TEST("VMNMX.MX.MRG_16L U32 U32",    0xbbbb2000, vmnmx_mx_u32_u32_mrg_16l,  8),
    TEST("VMNMX.MX.MRG_8B0 U32 U32",    0xaabbcc12, vmnmx_mx_u32_u32_mrg_8b0,  8),
    TEST("VMNMX.MX.MRG_8B0 U32 U32",    0xaa12ccdd, vmnmx_mx_u32_u32_mrg_8b2,  8),
    TEST("VMNMX.SAT 1",                 0x00000000, vmnmx_sat_1,               8),
    TEST("VMNMX.SAT 2",                 0x00000000, vmnmx_sat_2,               8),
    TEST("VMNMX.SAT 3",                 0x00000008, vmnmx_sat_3,               8),
    TEST("VMNMX.SAT 4",                 0x7fffffff, vmnmx_sat_4,               8),
    TEST("VMNMX.SAT 5",                 0x90000000, vmnmx_sat_5,               8),
    TEST("VMNMX.SAT 6",                 0x7fffffff, vmnmx_sat_6,               8),
    TEST("VMNMX.SAT 7",                 0x90000000, vmnmx_sat_7,               8),
